...
public class TodoResource {
	...
	public List<Todo> getAllTodo(@PathVariable String username){
		return todoService.retriveAllTodo();
	}
	...
	public ResponseEntity<Void> deleteTodo(
		...
		return ResponseEntity.notFound().build(); ////send back a not found status - IMPORTANT 
	}
	...
	//POST
	@PostMapping("/users/{username}/todos") //never leave a '/' on the end of the mapping uri 

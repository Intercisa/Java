...
@ControllerAdvice //make applicable this class to all of the controller across the app -> share across the app 
@RestController
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleUserNotFoundException(UserNotFountException ex, WebRequest request) {
